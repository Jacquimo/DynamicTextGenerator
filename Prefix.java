...
public class Prefix {
     ...
     * sentenceStartPrefixes array will have the correct length (i.e. correct
     * number of elements).
	 * <P>
	 * If this method is not called every time a new file is trained, the
     * program may inexplicably fail (especially if the length of the prefix has been changed).
	 */
	...
	/**
	 * Returns a String[] whose contents (empty strings) are used to retrieve
     * the Start-of-Sentence Prefix object.
	 * <P>
	 ...
	 * <P>
	 * This method does not perform bounds checking. Therefore, passing an
     ...
     * integral to the sentence generation stage. This function works by using
     * Math.random() to select a valid index for the array of suffixes. This
     * method returns the string at that index.
	 * <P>
	 * Warining: If the suffix array is empty (i.e. suffixes.length == 0), this
     * method will throw an Array Index Out-of-Bounds Exception. Therefore,
	...
	/**
	 * Determines equality among Prefix objects. Two Prefix objects are considered
     * equal if they both have the exact same string prefixes in the same order.
     *
	...
	public String toString() {
		// Since what makes a prefix unique is its order or words prefixes, the
        // prefixes are what should be printed for this class
